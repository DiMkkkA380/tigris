...
//--------------------------------------------------\\
vk.setOptions({
    token: '25718b1f8996abeb1f9801716dc6214bd221f57aede7ff0ddd199289cb6b0591eb83f34ae04a4618267a8',
    apiMode: 'parallel',
...
vk.updates.use(async (message, next) => {  	
	...
	if(/\[tigris_original\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[tigris_original\|(.*)\]/ig, '').trim();
